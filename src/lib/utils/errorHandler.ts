import { DEFAULT_ERROR_MESSAGE } from '@/lib/data/appData'
 ...
 */
export default function handleError(error: unknown, customMessage?: CustomMessage | undefined): void {
  ...
  console.error('API 호출 에러:', error.response?.data, error.message, new Date().toISOString())
}
