import { buttonColor, buttonStyle } from '@/components/MainButton'
...
export type AgeType = '20세 ~ 29세' | '30세 ~ 39세' | '40세 ~ 49세' | '50세 ~ 59세' | '60세 이상' | '직접입력' | string
...
export const LIST_ALBATALK_ORDER_BY_KEYS = Object.keys(LIST_ALBATALK_ORDER_BY) as Array<ListAlbatalkOrderByType>
